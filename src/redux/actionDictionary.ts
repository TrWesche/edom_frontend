...
export class USER_ACTIONS {
    ...
    static FINISH_USER_LOAD_PUBLIC = 'FINISH_USER_LOAD_PUBLIC';
    static FINISH_USER_LOAD_PRIVATE = 'FINISH_USER_LOAD_PRIVATE';
...
export class ROOM_ACTIONS {
    ...
    static FINISH_ROOM_LOAD_PUBLIC = 'FINISH_ROOM_LOAD_PUBLIC';
    static FINISH_ROOM_LOAD_PRIVATE = 'FINISH_ROOM_LOAD_PRIVATE';
...
export class EQUIP_ACTIONS {
    ...
    static FINISH_EQUIP_LOAD_PUBLIC = 'FINISH_EQUIP_LOAD_PUBLIC';
    static FINISH_EQUIP_LOAD_PRIVATE = 'FINISH_EQUIP_LOAD_PRIVATE';
